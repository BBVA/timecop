import os
import sys
from sqlalchemy import Column, ForeignKey, Integer, String,LargeBinary,DATETIME,Text
...
def new_model(name, winner, model,params):
    ...
    new_model = Model(TS_name=name, TS_winner_name = winner, TS_model=model,TS_model_params= params)
